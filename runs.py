...
y_stela = D_g.L * x_subsample 
mu = 0.01 * np.linalg.norm(np.dot(y_stela,D_g.L.toarray()),np.inf)
objval, x_stela, error_stela = stela_lasso(D_g.L.toarray(),y_stela,mu,10000)
